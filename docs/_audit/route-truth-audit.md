...
- staging → bromo_area_sunrise_staging[final_jvto_standard]; banyuwangi_staging[final_jvto_standard]
- route_recommendations → avoid_backtracking_ijen_bromo_ketapang[live_condition]; ferry_bali_buffer_required[live_condition]; ijen_access_closure_risk[live_condition]
